...
public class IGSGetFirstPointIoxPluginTest {
    private TransferDescription td = null;
    private static final String TEST_IN = "src/test/data/IGS_getFirstPoint/";
    ...
    public void setUp() throws Exception {
        ...
        {
            FileEntry fileEntry = new FileEntry(TEST_IN+"Validierung_IGS_getFirstPoint.ili", FileEntryKind.ILIMODELFILE);
            ili2cConfig.addFileEntry(fileEntry);
        }
    ...
    private void runValidation(File xtffile, LogCollector logger) throws IoxException {
        ...
        newFunctions.put("IGSFunction.IGS_getFirstPoint", IGSGetFirstPointIoxPlugin.class);
    ...
    @Test
    public void getFirstPoint_Ok() throws Exception {
        LogCollector logger = new LogCollector();
        runValidation(new File(TEST_IN+"getFirstPoint_Ok.xtf"), logger);
                
        assertEquals(0, logger.getErrs().size());   
    }
    
    @Test
    public void getFirstPoint_Fail() throws Exception {
        LogCollector logger = new LogCollector();
        runValidation(new File(TEST_IN+"getFirstPoint_Fail.xtf"), logger);
