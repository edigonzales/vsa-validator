...
public class IGSIsInsideSurfaceIoxPluginTest {
    private TransferDescription td = null;
    private static final String TEST_IN = "src/test/data/IGS_isInsideSurface/";
    ...
    public void setUp() throws Exception {
        ...
        {
            FileEntry fileEntry = new FileEntry(TEST_IN+"Validierung_IGS_isInsideSurface.ili", FileEntryKind.ILIMODELFILE);
            ili2cConfig.addFileEntry(fileEntry);
        }
    ...
    private void runValidation(File xtffile, LogCollector logger) throws IoxException {
        ...
        newFunctions.put("IGSFunction.IGS_isInsideSurface", IGSIsInsideSurfaceIoxPlugin.class);
    ...
    @Test
    public void isInsideSurface_Ok() throws Exception {
        LogCollector logger = new LogCollector();
        runValidation(new File(TEST_IN+"isInsideSurface_Ok.xtf"), logger);
                
        assertEquals(0, logger.getErrs().size());   
    }
    
    @Test
    public void isInsideSurface_Fail() throws Exception {
        LogCollector logger = new LogCollector();
        runValidation(new File(TEST_IN+"isInsideSurface_Fail.xtf"), logger);
