...
public class IGSGetLastPointIoxPluginTest {
    private TransferDescription td = null;
    private static final String TEST_IN = "src/test/data/IGS_getLastPoint/";
    ...
    public void setUp() throws Exception {
        ...
        {
            FileEntry fileEntry = new FileEntry(TEST_IN+"Validierung_IGS_getLastPoint.ili", FileEntryKind.ILIMODELFILE);
            ili2cConfig.addFileEntry(fileEntry);
        }
    ...
    private void runValidation(File xtffile, LogCollector logger) throws IoxException {
        ...
        newFunctions.put("IGSFunction.IGS_getLastPoint", IGSGetLastPointIoxPlugin.class);
    ...
    @Test
    public void getLastPoint_Ok() throws Exception {
        LogCollector logger = new LogCollector();
        runValidation(new File(TEST_IN+"getLastPoint_Ok.xtf"), logger);
                
        assertEquals(0, logger.getErrs().size());   
    }
    
    @Test
    public void getLastPoint_Fail() throws Exception {
        LogCollector logger = new LogCollector();
        runValidation(new File(TEST_IN+"getLastPoint_Fail.xtf"), logger);
