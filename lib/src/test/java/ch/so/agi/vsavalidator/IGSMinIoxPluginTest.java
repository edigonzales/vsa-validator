...
public class IGSMinIoxPluginTest {
    private TransferDescription td = null;
    private static final String TEST_IN = "src/test/data/IGS_min/";
    ...
    public void setUp() throws Exception {
        ...
        {
            FileEntry fileEntry = new FileEntry(TEST_IN + "Validierung_IGS_min.ili", FileEntryKind.ILIMODELFILE);
            ili2cConfig.addFileEntry(fileEntry);
        }
    ...
    private void runValidation(File xtffile, LogCollector logger) throws IoxException {
        ...
        newFunctions.put("IGSFunction.IGS_min", IGSMinIoxPlugin.class);
    ...
    @Test
    public void calculateMinimum() throws Exception {
        LogCollector logger = new LogCollector();
        runValidation(new File(TEST_IN+"calculate_minimum.xtf"), logger);
