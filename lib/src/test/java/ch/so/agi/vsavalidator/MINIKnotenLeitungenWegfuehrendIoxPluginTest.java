...
public class MINIKnotenLeitungenWegfuehrendIoxPluginTest {
    ...
    private static final String TEST_IN = "src/test/data/MINI_Knoten_Leitungen_wegfuehrend/";
    ...
    public void setUp() throws Exception {
        ...
        {
            FileEntry fileEntry = new FileEntry(TEST_IN + "Validierung_MINI_Knoten_Leitungen_wegfuehrend.ili", FileEntryKind.ILIMODELFILE);
            ili2cConfig.addFileEntry(fileEntry);
        }
