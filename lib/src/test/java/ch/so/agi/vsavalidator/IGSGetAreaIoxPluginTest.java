...
public class IGSGetAreaIoxPluginTest {
    private TransferDescription td = null;
    private static final String TEST_IN = "src/test/data/IGS_getArea/";
    ...
    public void setUp() throws Exception {
        ...
        {
            FileEntry fileEntry = new FileEntry(TEST_IN+"Validierung_IGS_getArea.ili", FileEntryKind.ILIMODELFILE);
            ili2cConfig.addFileEntry(fileEntry);
        }
    ...
    private void runValidation(File xtffile, LogCollector logger) throws IoxException {
        ...
        newFunctions.put("IGSFunction.IGS_getArea", IGSGetAreaIoxPlugin.class);
    ...
    @Test
    public void getArea_Ok() throws Exception {
        LogCollector logger = new LogCollector();
        runValidation(new File(TEST_IN+"getArea_Ok.xtf"), logger);
                
        assertEquals(0, logger.getErrs().size());   
    }
    
    @Test
    public void getArea_Fail() throws Exception {
        LogCollector logger = new LogCollector();
        runValidation(new File(TEST_IN+"getArea_Fail.xtf"), logger);
